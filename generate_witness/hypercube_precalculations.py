import generate_witness.affine_maps as affine_maps
...
def load(K, infinite = False):
    ...
    if infinite:
        PICKLE_FILE_NAME = 'generate_witness/PRECALC_FOR_K=%d_WITH_INFINITE_SOUNDNESS.pickle' % K
    else:
        PICKLE_FILE_NAME = 'generate_witness/PRECALC_FOR_K=%d_WITH_FINITE_SOUNDNESS.pickle' % K
